...
enum MYID
{
    ...
    ID_INDENTATION,
    ID_INDENTATION_TAB,
    ID_INDENTATION_WIDTH_2,
    ID_INDENTATION_WIDTH_4,
    ID_INDENTATION_WIDTH_8,
    ID_INDENTATION_SPACE,
    ID_CONVERT_INDENTATION,
    ID_CONVERT_INDENTATION_TAB,
    ID_CONVERT_INDENTATION_SPACE,
    ID_CONVERT_INDENTATION_WIDTH_2,
    ID_CONVERT_INDENTATION_WIDTH_4,
    ID_CONVERT_INDENTATION_WIDTH_8,
    ID_DEFAULT,
